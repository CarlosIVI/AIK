...
variable "aik_key_name" {
  ...
  default     = "estudianteAutomatizacion2"
}
...
variable "alb_name" {
  ...
  type        = string
  default     = "alb-aik-est10-2"
}

variable "instance_security_group_name" {
  description = "The name of the security group for the EC2 Instances"
  type        = string
  default     = "instances-sg-est10"
}

variable "alb_security_group_name" {
  description = "The name of the security group for the ALB"
  type        = string
  default     = "alb-sg-est10"
}

variable "aik_db_username" {
  description = "UserNameDB"
  default = "aikdb"
}

variable "aik_db_password" {
  description = "PasswordDB"
  default = "aikdbpassword"
}
